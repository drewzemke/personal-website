...
const computePointCoords = (point: PointData, t: number) => {
...
function Point(point: PointData) {
  ...
  useFrame(({ clock }) => {
    ...
    const { x, y, z } = computePointCoords(point, elapsed);
...
export function Points() {
  const points: PointData[] = useMemo(initialPoints, []);
